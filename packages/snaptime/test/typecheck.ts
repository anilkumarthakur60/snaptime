...
const wiy: number = df.weeksInIsoYear()
...
const _ld: LocaleData | null = null
const _lrt: LocaleRelativeTime | null = null
const _lcal: LocaleCalendar | null = null
const _plugin: PluginFn = () => {}
const _cgo: CalendarGridOptions = { weekStart: 'monday' }
...
void [cron, cronDirect, _matches, _next, _prev, _cronBetween, _cronHumanize]
...
void [_ld, _lrt, _lcal, _plugin, _cgo, _cronField]
