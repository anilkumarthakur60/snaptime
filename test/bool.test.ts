...
describe('dateFormat factory & API surface', () => {
  ...
  test('isSameYear', () => {
    expect(dateFormat('2025-05-04T12:00:00Z').isSameYear(dateFormat('2025-05-04T12:00:00Z'))).toBe(
      true
    )
    expect(dateFormat('2025-05-04T12:00:00Z').isSameYear(dateFormat('2026-05-04T12:00:00Z'))).toBe(
      false
    )
  })
  test('isCurrentYear', () => {
  ...
  test('isSameWeek', () => {
    expect(dateFormat('2025-05-04T12:00:00Z').isSameWeek(dateFormat('2025-05-04T12:00:00Z'))).toBe(
      true
    )
    expect(dateFormat('2025-05-04T12:00:00Z').isSameWeek(dateFormat('2025-05-05T12:00:00Z'))).toBe(
      false
    )
  })
  test('isCurrentWeek', () => {
  ...
  test('isSameDay', () => {
    expect(dateFormat('2025-05-04T12:00:00Z').isSameDay(dateFormat('2025-05-04T12:00:00Z'))).toBe(
      true
    )
    expect(dateFormat('2025-05-04T12:00:00Z').isSameDay(dateFormat('2025-05-05T12:00:00Z'))).toBe(
      false
    )
  })
  test('isCurrentDay', () => {
  ...
  test('isSameHour', () => {
    expect(dateFormat('2025-05-04T12:00:00Z').isSameHour(dateFormat('2025-05-04T12:00:00Z'))).toBe(
      true
    )
    expect(dateFormat('2025-05-04T12:00:00Z').isSameHour(dateFormat('2025-05-04T13:00:00Z'))).toBe(
      false
    )
  })
  test('isCurrentHour', () => {
  ...
  test('isSameMinute', () => {
    expect(
      dateFormat('2025-05-04T12:00:00Z').isSameMinute(dateFormat('2025-05-04T12:00:00Z'))
    ).toBe(true)
    expect(
      dateFormat('2025-05-04T12:00:00Z').isSameMinute(dateFormat('2025-05-04T12:01:00Z'))
    ).toBe(false)
  })
  ...
  test('isSameSecond', () => {
    expect(
      dateFormat('2025-05-04T12:00:00Z').isSameSecond(dateFormat('2025-05-04T12:00:00Z'))
    ).toBe(true)
    expect(
      dateFormat('2025-05-04T12:00:00Z').isSameSecond(dateFormat('2025-05-04T12:00:01Z'))
    ).toBe(false)
  })
  ...
  test('isSameMilli', () => {
    expect(dateFormat('2025-05-04T12:00:00Z').isSameMilli(dateFormat('2025-05-04T12:00:00Z'))).toBe(
      true
    )
    expect(
      dateFormat('2025-05-04T12:00:00Z').isSameMilli(dateFormat('2025-05-04T12:00:00.1Z'))
    ).toBe(false)
  })
  test('isCurrentMilli', () => {
  ...
  test('isSameMicro', () => {
    expect(dateFormat('2025-05-04T12:00:00Z').isSameMicro(dateFormat('2025-05-04T12:00:00Z'))).toBe(
      true
    )
    expect(
      dateFormat('2025-05-04T12:00:00Z').isSameMicro(dateFormat('2025-05-04T12:00:00.000001Z'))
    ).toBe(false)
  })
  test('isCurrentMicro', () => {
  ...
  test('isSameMicrosecond', () => {
    expect(
      dateFormat('2025-05-04T12:00:00Z').isSameMicrosecond(dateFormat('2025-05-04T12:00:00Z'))
    ).toBe(true)
    expect(
      dateFormat('2025-05-04T12:00:00Z').isSameMicrosecond(
        dateFormat('2025-05-04T12:00:00.000001Z')
      )
    ).toBe(false)
  })
  ...
  test('isSameDecade', () => {
    expect(
      dateFormat('2025-05-04T12:00:00Z').isSameDecade(dateFormat('2025-05-04T12:00:00Z'))
    ).toBe(true)
    expect(
      dateFormat('2025-05-04T12:00:00Z').isSameDecade(dateFormat('2035-05-04T12:00:00Z'))
    ).toBe(false)
  })
  ...
  test('isSameCentury', () => {
    expect(
      dateFormat('2025-05-04T12:00:00Z').isSameCentury(dateFormat('2025-05-04T12:00:00Z'))
    ).toBe(true)
    expect(
      dateFormat('2025-05-04T12:00:00Z').isSameCentury(dateFormat('2125-05-04T12:00:00Z'))
    ).toBe(false)
  })
  ...
  test('isSameMillennium', () => {
    expect(
      dateFormat('2025-05-04T12:00:00Z').isSameMillennium(dateFormat('2025-05-04T12:00:00Z'))
    ).toBe(true)
    expect(
      dateFormat('2025-05-04T12:00:00Z').isSameMillennium(dateFormat('3025-05-04T12:00:00Z'))
    ).toBe(false)
  })
  ...
  test('isSame', () => {
    ...
    expect(dateFormat('2025-05-04T12:00:00Z').isSame(dateFormat('2025-05-05T12:00:00Z'))).toBe(
      false
    )
  })
  test('isSameMillisecond', () => {
    expect(
      dateFormat('2025-05-04T12:00:00Z').isSameMillisecond(dateFormat('2025-05-04T12:00:00Z'))
    ).toBe(true)
    expect(
      dateFormat('2025-05-04T12:00:00Z').isSameMillisecond(dateFormat('2025-05-04T12:00:00.1Z'))
    ).toBe(false)
  })
  test('isCurrentMillisecond', () => {
    expect(dateFormat('2025-05-04T12:00:00Z').isCurrentMillisecond()).toBe(true)
    expect(
      dateFormat('2025-05-04T12:00:00Z').isCurrentMillisecond(
        dateFormat('2025-05-04T12:00:00.000001Z')
      )
    ).toBe(false)
  })
